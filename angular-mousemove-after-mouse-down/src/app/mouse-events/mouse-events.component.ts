...
export class MouseEventsComponent implements OnInit {
  ...
  register() {
    ...
    this._sub = this.mousehold$.subscribe((e) => {
      // const cellLeft = document.getElementsByClassName("cellLeft");
      // const cellRigth = document.getElementsByClassName("cellRigth");
      this.x = e.x;
      this.y = e.y;
      console.log(e.offsetX)
      this.cellLeft = this.cellLeft + e.movementX
